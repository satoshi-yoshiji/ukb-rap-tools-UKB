...
# sort chromosome as per https://groups.google.com/g/plink2-users/c/7pzJ50DQ0I8
run_regenie_cmd="
plink2 --bfile ${data_field}_allQC_v2_mrg_prun_cohort \
       --make-bed --out ${data_field}_allQC_v2_mrg_prun_cohort_sorted \ 

regenie --step 1 --out ap37_results \
 --bed ${data_field}_allQC_v2_mrg_prun_cohort_sorted \
